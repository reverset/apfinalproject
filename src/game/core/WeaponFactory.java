...
public class WeaponFactory {
    public static Weapon standardWeapon(Color color, Entity owner, Object[] ignoreTags) {
        return new Weapon(() -> {
            return BulletFactory.standardBullet(new Transform(), new Vec2(), color, owner, ignoreTags, BulletFactory.STANDARD_BULLET_LIFE);
    ...
    public static RadiusWeapon radiusWeapon(Color color, Entity owner, Object[] ignoreTags) {
        return new RadiusWeapon(() -> {
            return BulletFactory.standardBullet(new Transform(), new Vec2(), color, owner, ignoreTags, Duration.ofSeconds(1));
        }, 3, 600f, 45);
    }
}
